      ...
      <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden ml-24">
        ...
        <form method="POST" action="{{ route('register') }}" class="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
          ...
          <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full p-3 text-gray-700 leading-tight focus:ring transform transition hover:scale-105 duration-300 ease-in-out" id="name" name="name" type="text" value="{{ old('name') }}" placeholder="Masukkan nama" />
            @error('name')
            ...
            <input class="shadow appearance-none border rounded w-full p-3 text-gray-700 leading-tight focus:ring transform transition hover:scale-105 duration-300 ease-in-out" id="email" name="email" type="text" value="{{ old('email') }}" placeholder="Masukkan email" />
            @error('email')
            <div class="text-danger">{{ $message }}</div>
            @enderror
            ...
            <input type="password" class="shadow appearance-none border rounded w-full p-3 text-gray-700 leading-tight focus:ring transform transition hover:scale-105 duration-300 ease-in-out" id="password" name="password" placeholder="Masukkan password" />
            @error('password')
            <div class="text-danger">{{ $message }}</div>
            @enderror
            ...
            <input type="password" class="shadow appearance-none border rounded w-full p-3 text-gray-700 leading-tight focus:ring transform transition hover:scale-105 duration-300 ease-in-out" id="password_confirmation" name="password_confirmation" placeholder="Konfirmasi password" />
          ...
          <a href="{{ route('login') }}" class="bg-gradient-to-r text-blue-400 transform transition hover:scale-105 duration-300 ease-in-out" type="submit">
            Masuk
          </a>
        </form>
